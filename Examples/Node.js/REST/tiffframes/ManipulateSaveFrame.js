...
UploadFileBinary(
    ...
    function (response) {
        ...
        var method = 'GET';
        var request_url ='imaging/sample1.tiff/frames/0?saveOtherFrames=true&rotateFlipMethod=rotate90flipnone&newWidth=400&newHeight=400&x=20&y=20&rectWidth=100&rectHeight=100&outPath=' + output_file;
